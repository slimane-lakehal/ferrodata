...
from utils.db import get_db, query_data, get_all_routes

st.set_page_config(
    page_title="Route Explorer - SNCF Analytics",
    page_icon="🚄",
    layout="wide"
)
...
st.download_button(
    ...
    data=csv,
    file_name=f"sncf_route_analysis.csv",
    mime="text/csv"
)

st.markdown("---")
st.caption("💡 Select multiple routes to compare | Single route for historical trends | Data from SNCF Open Data")
